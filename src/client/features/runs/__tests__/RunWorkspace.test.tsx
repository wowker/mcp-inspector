...
const tool: ToolDetailSummary = { tool: { projectId, connectionId, name: "sum", status: "current", folderId: null,
  favorite: false, lastUsedAt: null, updatedAt: "2026-08-17T00:00:00.000Z",
